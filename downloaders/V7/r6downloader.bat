...
MODE 78,21
echo --------------------------------------------------------------------------
echo ^|      Rainbow Six Siege Downloader (V%CURRENT_VERSION%) - Written by JVAV           ^|
echo --------------------------------------------------------------------------
...
echo -------------------------------------------------------------------------
echo.
call :cmdMenuSel "  Main Menu" "  Refresh Menu" "  year 1" "  year 2" "  year 3" "  year 4" "  year 5" "  year 6" "  year 7" "  year 8" "  year 9" "  year 10" "  year 11"
...
call :format
echo.
call :cmdMenuSel "  Back to Seasons Menu" "  Refresh Menu" "  Deadly Omen      | Y9S1 | 54.4 GB | NO UNLOCKED OPERATORS" "  New Blood        | Y9S2 | 56.0 GB | SUPPORTS HEATED METAL" "  New Blood        | Y9S2 | 56.0 GB | NO UNLOCKED OPERATORS" "  Twin Shells      | Y9S3 | 59.2 GB | NO UNLOCKED OPERATORS" "  Collision Point  | Y9S4 | 59.2 GB | NO UNLOCKED OPERATORS"
if %ERRORLEVEL% == 1 call :downloadmenu
if %ERRORLEVEL% == 2 call :year9
if %ERRORLEVEL% == 3 call :Y9S1_DeadlyOmen
if %ERRORLEVEL% == 4 call :Y9S2_NewBloodHM
if %ERRORLEVEL% == 5 call :Y9S2_NewBlood
if %ERRORLEVEL% == 6 call :Y9S3_TwinShells
if %ERRORLEVEL% == 7 call :Y9S4_CollisionPoint
...
:Y9S2_NewBloodHM
echo You have selected New Blood Edition with Heated Metal Support
set SEASON="S2"
set PATCH="0"
call :downloading
goto year9
...
call :format
echo.
call :cmdMenuSel "  Back to Seasons Menu" "  Refresh Menu" "  Prep Phase       | Y10S1| 51.4 GB | NO UNLOCKED OPERATORS" "  Daybreak         | Y10S2| 57.6 GB | NO UNLOCKED OPERATORS" "  High Stakes      | Y10S3| 64.1 GB | NO UNLOCKED OPERATORS" "  Tenfold Pursuit  | Y10S4| 64.1 GB | NO UNLOCKED OPERATORS"
if %ERRORLEVEL% == 1 call :downloadmenu
...
:year11
Title Rainbow Six Siege Season 11 Download
set YEAR="Y11"
cls
MODE 70,20
echo -------------------------------------------------------------------------
echo ^| Click on one the seasons of Year 11 you like to choose.           ^|
echo -------------------------------------------------------------------------
echo.
call :format
echo.
...
if %ERRORLEVEL% == 4 call :Y11S1_SystemOverride
...
:Y11S1_SystemOverride
echo You have selected System Override Edition
set SEASON="S2"
set PATCH="8"
call :downloading
goto year11
...
cls
echo %OneDrive%
@REM echo %CD% | find /I "%OneDrive%" >nul && echo In OneDrive || echo Not in OneDrive
...
if NOT exist "Resources\ThrowbackLoader\LaunchR6.bat" (
    ...
    ::extracting the ThrowbackLoader
    powershell -NoProfile -Command "Expand-Archive -Path 'ThrowbackLoader.zip' -DestinationPath 'Resources\ThrowbackLoader' -Force; Remove-Item 'ThrowbackLoader.zip'"
